(() => {
  ...
  frappe.ui.form.PatientQuickEntryForm = class PatientQuickEntryForm extends frappe.ui.form.QuickEntryForm {
    ...
    render_dialog() {
      let custom_fields = this.mandatory.filter((field) => !this.get_standard_fields().map((field2) => field2.fieldname).includes(field.fieldname));
...
//# sourceMappingURL=healthcare.bundle.SVLPBHID.js.map
